...
let Q = document.getElementById("qa"), $ = Q.parentElement, Ue = document.createElement("div");
Ue.id = "shadow";
Q.after(Ue);
function qr() {
  console.log("clone");
...
function Er() {
  console.log("flip", $.className), document.getElementById("shadow").classList.remove("hidden"), $.classList.contains("front") ? $.classList.contains("back") || ($.classList.add("back"), $.classList.remove("front")) : ($.classList.remove("back"), $.classList.add("front")), Q.addEventListener("animationend", qr, { once: !0 }), console.log("flip started");
}
...
`, "	"], o = ["{", "}", "|", "\\", "^", "`"].concat(r), s = ["'"].concat(o), c = ["%", "/", "?", ";", "#"].concat(s), i = ["/", "?", "#"], a = 255, l = /^[+a-z0-9A-Z_-]{0,63}$/, f = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, m = {
  ...
  return u.prototype.parse = function(_, y) {
      ...
      if (!O) {
        ...
        for (d = 0, k = A.length; d < k; d++) {
          ...
          if (F && !F.match(l)) {
            ...
            if (!M.match(l)) {
              var Z = A.slice(0, d), P = A.slice(d + 1), U = F.match(f);
              U && (Z.push(U[1]), P.unshift(U[2])), P.length && (x = P.join(".") + x), this.hostname = Z.join(".");
              break;
            }
          }
        }
    ...
    var G = x.indexOf("#");
    G !== -1 && (this.hash = x.substr(G), x = x.slice(0, G));
    var nt = x.indexOf("?");
...
var Tn;
function eP() {
  return Tn || (Tn = 1, V.Any = Ze(), V.Cc = Ge(), V.Cf = nP(), V.P = un(), V.Z = We()), V;
}
var Mn;
function T() {
...
function yP() {
  ...
  return Mt = function(o, s, c, i) {
    var a, l, f, m, h, v, _, y, d, k, p, g, b, x, q, C, E, w, D, R, O, A, F, M, B, J, Z, P, U = !1, G = !0;
    ...
    if (g = o.src.charCodeAt(F - 1), i)
      return !0;
    for (p = o.tokens.length, _ ? (P = o.push("ordered_list_open", "ol", 1), b !== 1 && (P.attrs = [["start", b]])) : P = o.push("bullet_list_open", "ul", 1), P.map = k = [s, 0], P.markup = String.fromCharCode(g), q = s, M = !1, Z = o.md.block.ruler.getRules("list"), w = o.parentType, o.parentType = "list"; q < c; ) {
    ...
    return _ ? P = o.push("ordered_list_close", "ol", -1) : P = o.push("bullet_list_close", "ul", -1), P.markup = String.fromCharCode(g), k[1] = q, o.line = q, o.parentType = w, G && n(o, p), !0;
  }, Mt;
}
var zt, ee;
function CP() {
