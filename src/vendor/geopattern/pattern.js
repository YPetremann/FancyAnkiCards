import { hex2rgb, rgb2hsl, hsl2rgb, rgb2hex, rgb2rgbString } from "./color";
...
export class Pattern {
  ...
  generatePattern() {
    ...
    return this[
      "geo" + generator.slice(0, 1).toUpperCase() + generator.slice(1)
    ]();
  }
  geoHexagons() {
